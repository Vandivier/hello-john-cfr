/**
 *  file name: service-url-manager.service.js
 *  aliases: ServiceUrlManager, mUrlManager
 *
 *  description:
 ...
 * TODO: EllaUtils should install fetch behind the scenes as a dependency; I shouldn't have to seperately install that.
 * 
 * note: taken directly from below ref
 * ref: https://github.com/Vandivier/react-report-maker/blob/master/services/service-url-manager/service-url-manager.service.js
 **/
